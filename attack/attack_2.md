...
- **Severity**: Medium
- **Remediation goal**: Require the **amaljp** account to only be accessible via SSH keys and a passphrase. [Remediation for Attack 2](../remediation/remediation_attack_2.md)
