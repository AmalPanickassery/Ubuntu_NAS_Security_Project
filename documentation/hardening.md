...
The following modifications were made to the ***/etc/ssh/sshd_config*** after making a copy of it:
  ...
  8. **PermitUserEnvironment** no: Prevents users from supplying environment variables through SSH user-environment files. This helps reduce the ability for users to influence the environment of their SSH sessions.
